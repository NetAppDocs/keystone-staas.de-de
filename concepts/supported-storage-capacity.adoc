...
* Änderungen der zugesagten Kapazität können Sie über die Konsole oder über Ihren Keystone Success Manager (KSM) anfordern. Informationen zum Beantragen von Änderungen finden Sie unter link:../concepts/support-services.html["NetApp Keystone-Support"]Die
