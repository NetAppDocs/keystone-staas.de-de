...
Die Keystone STaaS-Services für ONTAP-Datei- und Block-Storage und StorageGRID Objekt-Storage unterstützen mehrere Funktionen und Protokolle. Die nachfolgende Tabelle enthält eine Beschreibung:
