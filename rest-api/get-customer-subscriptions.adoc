...
---
= Keystone Kundenabonnements über die Digital Advisor REST-API abrufen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Diese API ruft eine Liste aller Abonnements und Leistungsservicelevel ab, die mit der angegebenen Kunden-ID verknüpft sind.
...
Die API antwortet mit einem JSON-Objekt, das eine Liste aller Abonnements und der zugehörigen Leistungsserviceleveldetails für den jeweiligen Kunden enthält. Hier ist eine Beispielantwort:
