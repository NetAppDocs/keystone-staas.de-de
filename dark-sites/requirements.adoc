...
---
= Installationsvoraussetzungen für Keystone Collector im privaten Modus
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: Nur die oben aufgeführten Drittanbieterpakete werden auf Keystone Collector unterstützt. Die Installation zusätzlicher Software wird nicht unterstützt und kann die Collector-Leistung, die Datenerfassung und die Abrechnungsgenauigkeit beeinträchtigen.
...
* Jeden Monat wird eine Datei aus Keystone Collector exportiert und per E-Mail an das NetApp Support-Team gesendet. Weitere Informationen zur Kontaktaufnahme mit dem Support-Team finden sich unter link:../concepts/support-services.html["Support-Services für Keystone"].
