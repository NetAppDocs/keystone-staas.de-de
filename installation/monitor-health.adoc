...
---
= Gesundheitsüberwachung für Keystone Collector
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
. Wenn die Datei heruntergeladen ist, können Sie sie an das Keystone ServiceNow-Supportticket anhängen. Informationen zum Sammeln von Tickets finden Sie unter link:../concepts/support-services.html["Serviceanforderungen werden erstellt"]Die
