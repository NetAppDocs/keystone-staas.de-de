...
. Active IQ Unified Manager (Unified Manager) neuer als 9.10 und vor 9.16P2
...
. Stellen Sie sicher, dass Unified Manager in einer Version später als 9.10 und früher als 9.16P2 konfiguriert ist. Informationen zur Installation von Unified Manager sind unter den folgenden Links verfügbar:
+
