...
.Schritte
. Laden Sie die OVA-Datei von herunter https://[] Auf Ihrem VMware vSphere System speichern.
...
.. Laden Sie das öffentliche Zertifikat _Keystone Billing_ herunter: https://[].
