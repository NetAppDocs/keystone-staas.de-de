...
. Aktualisieren Sie Keystone Collector mit der Option *Wartung > System aktualisieren*. Einige ausgewählte Spiegelungen sind möglicherweise nicht verfügbar, und die Systemdetails werden nach einigen Versuchen aktualisiert.
