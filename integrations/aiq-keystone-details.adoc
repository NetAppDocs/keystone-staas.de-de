...
Sie können auf die Umschalttaste *Aktuelle Nutzung anzeigen* klicken, um den aktuellen Verbrauch und die Burst-Nutzung in Bezug auf den Abrechnungszeitraum des Abonnements anzuzeigen. Diese basieren nicht auf dem Datumsbereich der Abfrage.
