...
image:aiq-ks-subtime-2.png["Registerkarte „Kapazitätstrend“"]
...
Wenn Sie das sekundäre Abonnement überprüfen, können Sie sehen, dass das Balkendiagramm für den _Extreme_ Service Level (Basisservice Leverent Usagel) am gleichen Datenerfassungspunkt wie die Partnerseite umgekehrt wird, und die Trennung des Verbrauchs an den primären und gespiegelten Standorten ist 1.05 tib bzw. 1.02 tib.
