...
+
Sie sehen detaillierte Informationen zu allen Volumes in Clustern über Keystone Subscriptions hinweg, einschließlich Volume-Name, Subscription-Nummer, Node-Seriennummer, Einhaltung von QoS-Richtlinien, Clustername, Hostname und Performance-Servicelevel. Sie können die bereitgestellte Kapazität, die logische und physische Auslastung, Cold Data und Hot Data überwachen. Sie erhalten außerdem eine Übersicht über:
