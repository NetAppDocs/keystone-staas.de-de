...
+
Das Liniendiagramm zeigt historische Verbrauchsdaten und ermöglicht es den Benutzern, Trends über einen ausgewählten Datumsbereich zu analysieren. Das Diagramm zeigt Kennzahlen wie die verwendete Kapazität (Gesamtspeicherkapazität, einschließlich sowohl Daten als auch Snapshot-Daten), Daten (Speicherkapazität, die von Benutzerdaten verwendet wird), und Snapshot (Speicherkapazität, die von Snapshot-Daten verwendet wird), zusammen mit zugesicherter und Burst-Kapazität. Basierend auf dem Datumsbereich Ihrer Abfrage zeigen die Nutzungsdiagramme bis zu 30 Datenerfassungspunkte an. Sie können den Mauszeiger über das Diagramm bewegen, um die Nutzungsaufschlüsselung an jedem Datenerfassungspunkt anzuzeigen.
