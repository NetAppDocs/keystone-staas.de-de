...
Sie können die voraussichtliche Kapazitätsauslastung für die nächsten 120 Tage ab dem aktuellen Datum über die *Forecast*-Umschaltfunktion in der Ansicht *Historical consumption* auf der Registerkarte *Consumption trend* in der Console einsehen. Die Umschaltfunktion ist standardmäßig aktiviert.

Standardmäßig zeigt das Diagramm den historischen Verbrauch der letzten 30 Tage sowie eine 120-Tage-Prognose ab dem aktuellen Datum im selben Diagramm an. Insgesamt werden bis zu 30 Datenpunkte dargestellt (20 für historische Daten und 10 für Prognosedaten), wobei eine vertikale Linie die beiden Segmente trennt.

image:forecast-1.png["Screenshot mit Prognosedaten"]

Wenn Sie einen Datumsbereich auswählen, der nicht mit dem aktuellen Datum endet, wird die Prognose automatisch deaktiviert. Um sie wieder zu aktivieren, werden Sie in einem Bestätigungsdialog darauf hingewiesen, dass Prognosedaten nur verfügbar sind, wenn der ausgewählte Zeitraum mit dem aktuellen Datum endet. Durch Bestätigen wird die Ansicht auf den Standardbereich der letzten 30 Tage historischer Daten plus die nächsten 120 Tage Prognose zurückgesetzt.

Wenn der prognostizierte Verbrauch die Burst-Kapazität voraussichtlich übersteigt, erscheint ein Warnhinweis im Diagramm, der eine Kapazitätserweiterung empfiehlt.
