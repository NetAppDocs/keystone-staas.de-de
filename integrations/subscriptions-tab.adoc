...
** *Verknüpfte Abonnements*: Wenn Sie sekundäre Abonnements mit Ihrem Hauptabonnement verknüpft haben, listet diese Spalte die verknüpften Abonnementnummern für das Hauptabonnement auf.
