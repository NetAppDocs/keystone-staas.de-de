...
+
image:console-subscription.png["Details der Registerkarte „Abonnement“ anzeigen"]
...
+
** *Abonnementnummer*: Die Abonnementnummer des Keystone-Abonnements, die von NetApp vergeben wurde. Abonnements mit dem image:metrocluster-icon.png["MetroCluster Abonnement-Symbol"] Symbol sind MetroCluster-Abonnements. Weitere Informationen zu MetroCluster-Abonnements finden Sie unter link:../integrations/adp-tab.html["Verbrauch und Status Ihrer Keystone MetroCluster Abonnements einsehen"].
...
** *Verknüpfte Abonnements*: Falls Sie weitere Abonnements mit Ihrem Hauptabonnement verknüpft haben, werden in dieser Spalte die Nummern der verknüpften Abonnements für das Hauptabonnement angezeigt. Diese Spalte ist standardmäßig ausgeblendet und wird nur angezeigt, wenn verknüpfte Abonnements verfügbar sind.
** *Keystone-Version*: Die Version des Keystone-Dienstes, die für das Abonnement verwendet wird. Die Tarifplanregeln für Leistungsdienststufen können je nach Abonnementversion unterschiedlich sein. Weitere Informationen zu Version v1 finden Sie unter  https://docs.netapp.com/us-en/keystone/index.html["Keystone-Abonnementdienste | Dokumentation Version 1"^]. Diese Spalte ist standardmäßig ausgeblendet und kann mit dem Spaltenauswahl-image:column-selector.png["Spaltenauswahlsymbol"]-Symbol aktiviert werden.
** *Nutzungsart*: Möglicherweise haben Sie mehrere Keystone Versionen abonniert. Die Tarifregeln für Leistungs-Servicelevel können sich je nach Abonnementversion unterscheiden. Anhand des Werts in dieser Spalte wissen Sie, ob die Nutzungsart gemäß der bereitgestellten, physischen oder logischen Nutzung abgerechnet wird. Weitere Informationen zu Version 1 finden Sie unter  https://docs.netapp.com/us-en/keystone/index.html["Keystone-Abonnementdienste | Dokumentation Version 1"^].
...
** *Tage bis zum Ablauf des Abonnements*: Neben dem Ablaufdatum wird ein Symbol angezeigt, das angibt, wie nah das Abonnement am Ablauf ist und ob es sich automatisch verlängert. Dieser Status ist schreibgeschützt und spiegelt Ihre Vertragsbedingungen wider. Zur Überprüfung der Vertragsdetails siehe link:../integrations/subscription-timeline.html["Sehen Sie sich die Zeitleiste Ihrer Keystone-Abonnements an"].
+
Wenn die automatische Verlängerung deaktiviert ist, zeigt die Symbolfarbe die Nähe des Ablaufdatums an:

+
*** *Grün*: Mehr als 120 Tage verbleiben bis zum Ablauf.
*** *Orange*: Bis zum Ablauf verbleiben 91 bis 120 Tage.
*** *Rot*: Weniger als 90 Tage verbleiben bis zum Ablauf. Um eine Serviceunterbrechung zu vermeiden, sollte ein Verlängerungsantrag beim NetApp Keystone Support eingereicht werden.
*** *Grau*: Das Abonnement ist abgelaufen.
+
Bei Abonnements mit aktivierter automatischer Verlängerung wird ein Symbol für die automatische Verlängerung angezeigt, das darauf hinweist, dass sich das Abonnement am Ende der aktuellen Laufzeit automatisch verlängert.

+

NOTE: Sie können auf den Pfeil nach unten image:down-arrow.png["Symbol zum Erweitern"] in der Tabellenüberschrift klicken, um alle Abonnements zu erweitern und die Informationen zu den Performance-Service-Levels für jedes Abonnement gleichzeitig anzuzeigen. Dies zeigt detaillierte Kapazitätsinformationen, einschließlich aktueller Nutzung, zugesicherter Kapazität, bereitgestellter Kapazität, Spitzenkapazität und verfügbarer Kapazität für alle Abonnements. Alternativ können Sie auf den Pfeil nach unten neben der Spalte *Ablaufdatum* in den einzelnen Abonnementzeilen klicken, um diese einzeln zu erweitern.
...
** *Verknüpfte Abonnements*: Falls Sie sekundäre Abonnements mit Ihrem primären Abonnement verknüpft haben, werden in dieser Spalte die verknüpften Abonnementnummern für das primäre Abonnement aufgelistet.
